...
if st.session_state.button_clicked:
    ...
    if st.checkbox("Compare Policies"):
    ...
    if st.button("Run Simulation"):
        demand_data = generate_demand(distribution1, max(duration1, duration2) if st.checkbox("Compare Policies") else duration1, mean_demand1, std_dev1)
        ...
        if st.checkbox("Compare Policies") and policy2 == "R,S":
        ...
        if st.checkbox("Compare Policies") and policy2 == "s,Q":
        ...
        }) if st.checkbox("Compare Policies") else None

        # Ensure sheet names are valid by removing any special characters
        valid_policy1 = ''.join(e for e in policy1 if e.isalnum())
        valid_policy2 = ''.join(e for e in policy2 if e.isalnum()) if st.checkbox("Compare Policies") else None
