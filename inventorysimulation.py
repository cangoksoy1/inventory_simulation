...
if st.button('Press Me', key='press_me_button', position: absolute; top: 300px; left: 50%; transform: translateX(-50%); on_click=lambda: st.session_state.update(button_clicked=True)):
