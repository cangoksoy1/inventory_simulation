...
with col1:
    ...
    if policy1 == "s,Q":
        ...
        s1 = st.number_input("Reorder Point (s)", value=20, key='s2')
        Q1 = st.number_input("Order Quantity (Q)", value=40, key='Q2')
        S1 = None
    elif policy1 == "s,S":
        s1 = st.number_input("Reorder Point (s)", value=20, key='s3')
        S1 = st.number_input("Order-up-to Level (S)", value=100, key='S1')
        R1 = None
        Q1 = None
    elif policy1 == "R,s,S":
        R1 = st.number_input("Review Period (R)", value=10, key='R2')
        s1 = st.number_input("Reorder Point (s)", value=20, key='s4')
        S1 = st.number_input("Order-up-to Level (S)", value=100, key='S2')
        Q1 = None
...
with col2:
    ...
    if policy2 == "s,Q":
        s2 = st.number_input("Reorder Point (s)", value=20, key='s5')
        Q2 = st.number_input("Order Quantity (Q)", value=40, key='Q3')
        R2 = None
        S2 = None
    elif policy2 == "R,s,Q":
        R2 = st.number_input("Review Period (R)", value=10, key='R3')
        s2 = st.number_input("Reorder Point (s)", value=20, key='s6')
        Q2 = st.number_input("Order Quantity (Q)", value=40, key='Q4')
        S2 = None
    elif policy2 == "s,S":
        s2 = st.number_input("Reorder Point (s)", value=20, key='s7')
        S2 = st.number_input("Order-up-to Level (S)", value=100, key='S3')
        R2 = None
        Q2 = None
    elif policy2 == "R,s,S":
        R2 = st.number_input("Review Period (R)", value=10, key='R4')
        s2 = st.number_input("Reorder Point (s)", value=20, key='s8')
        S2 = st.number_input("Order-up-to Level (S)", value=100, key='S4')
        Q2 = None

# Single Service Level input
...
if st.button("Run Simulation"):
    ...
    file_path = 'inventory_comparison.csv'
    ...
    st.download_button('Download CSV', data=open(file_path, 'rb'), file_name=file_path, mime='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')
