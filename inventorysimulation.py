...
# Widgets for initial input parameters
...
# Button to show further calculation inputs
if st.button("Further Calculation"):
    st.session_state.show_additional_inputs = True

# Display additional input fields based on policy selection
if 'show_additional_inputs' in st.session_state and st.session_state.show_additional_inputs:
